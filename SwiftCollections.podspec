#
#  Be sure to run `pod spec lint SwiftCollections.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = "Apple"
  # Or just: spec.author    = "Kamil Piasek"
  # spec.authors            = { "Kamil Piasek" => "kamil.piasek@codequest.com" }
  # spec.social_media_url   = "https://twitter.com/Kamil Piasek"
  ...
  spec.exclude_files = ["Sources/CollectionsTestSupport/**/*.swift", "Sources/Collections/**/*.*"]
